...
function KnowMore() {
  return (
    ...
    <ul>
     <li>✅ Productos certificados y libres de químicos nocivos</li>
     <li>✅ Envases reutilizables, compostables o reciclables</li>
     <li>✅ Envíos con huella de carbono reducida</li>
     <li>✅ Apoyo a pequeños productores y marcas sostenibles</li>
    </ul>
    
    <p>Únete a nuestra comunidad y haz de cada compra un acto de amor por el planeta. 💚 🌎</p>
    <h3>📦 Compra fácil y recibe en casa → www.EcoStore.com</h3>
    </div>
  )
}
